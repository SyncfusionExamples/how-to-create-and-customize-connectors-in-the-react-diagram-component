...
A quick-start React app that shows how to create and customize connectors in the [React Diagram](https://www.syncfusion.com/diagram-sdk/react-diagram) Component. It explains how to customize connector types,connector decorator types, edit and remove connectors and draw connector using drawing tool.
